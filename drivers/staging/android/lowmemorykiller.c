...
static int lowmem_adj_size = 6; static int lowmem_minfree[6] = {
...
static int lowmem_minfree_size = 4; static int lmk_fast_run = 1; static unsigned long 
...
__module_param_call(MODULE_PARAM_PREFIX, adj,
		    ...
		    .arr = &__param_arr_adj,
		    S_IRUGO | S_IWUSR, -1); __MODULE_PARM_TYPE(adj, "array of int");
#else
